...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_f2 << Ft;
    acadodata_f2 << phidot_d;
    acadodata_f2 << thetadot_d;
    acadodata_f2 << psidot_d;
    acadodata_f2 << x;
    acadodata_f2 << y;
    acadodata_f2 << z;
    acadodata_f2 << psi;
    DMatrix acadodata_M1;
    acadodata_M1.read( "multirotor_data_acadodata_M1.txt" );
    ...
    acadodata_f1 << dot(phi) == phidot_d;
    acadodata_f1 << dot(theta) == thetadot_d;
    acadodata_f1 << dot(psi) == psidot_d;
