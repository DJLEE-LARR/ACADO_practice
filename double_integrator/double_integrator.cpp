...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_M1.read( "double_integrator_data_acadodata_M1.txt" );
    ...
    acadodata_M2.read( "double_integrator_data_acadodata_M2.txt" );
    DifferentialEquation acadodata_f1;
    acadodata_f1 << dot(x) == xdot;
    acadodata_f1 << dot(xdot) == F;
    ...
    ocp1.subjectTo((-1.00000000000000000000e+01) <= F <= 1.00000000000000000000e+01);
